...
templates['skillTable'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<table>\n    <thead>\n    <th>Beginner</th>\n    <th>Developed</th>\n    <th>Experiened</th>\n    </thead>\n\n    <tr>\n        <td class=\"rightBorder\">\n"
    ...
    + "        </td>\n        <td class=\"rightBorder\">\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.developed : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "    </td>\n    <td>\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.experienced : depth0),{"name":"each","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "        </td>\n    </tr>\n\n\n</table>";
},"useData":true});
})();