...
templates['skillTable'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<table class=\"skillTable table table-responsive\">\n    <thead class=\"skillThead\">\n    <th class=\"skillth\"></th>\n    </thead>\n\n    <tr class=\"skillTr\">\n        <td class=\"skillTd rightBorder\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.developed : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "        </td>\n    </tr>\n\n\n</table>";
},"useData":true});
})();